...
## Score predictions
results_path = Path("resources/results/predictions/familywise")
...
def filename_to_model_name(filename):
    ...
    model = f"{model_transform[parts[0]]} {cut_model} + {model_transform[parts[3]]}"
...
data = pd.concat(
    [
        ...
        for x in [
            ...
            "LinearFold",
            # "MXfold2",
            # "DivideFold MLP + RNAfold",
            # "DivideFold MLP + LinearFold",
            # "DivideFold MLP + MXfold2",
            # "DivideFold BiLSTM + RNAfold",
            # "DivideFold BiLSTM + LinearFold",
            # "DivideFold BiLSTM + MXfold2",
            # "DivideFold CNN + RNAfold",
            "DivideFold CNN + LinearFold",
            "DivideFold CNN + MXfold2",
            # "DivideFold Oracle + RNAfold",
            "DivideFold Oracle + LinearFold",
            "DivideFold Oracle + MXfold2",
        ]
    ]
)
